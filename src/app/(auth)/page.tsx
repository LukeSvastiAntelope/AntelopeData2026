...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center w-screen h-screen bg-mainGradient bg-cover bg-center bg-no-repeat m-0">
      ...
      <div className="bg-[#00000020] p-5 rounded-xl flex flex-col items-center justify-center">
      <Image
        ...
        <div className="flex flex-col gap-1 w-full">
          <Link href={"/register"} className="bg-tertiary text-center text-white p-[10px] rounded-[6px] text-[15px] hover:bg-primary">Register</Link>
