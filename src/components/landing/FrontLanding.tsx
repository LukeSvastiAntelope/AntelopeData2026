        ...
        <div className="p-6 space-y-16">
          ...
          <section className="text-center max-w-2xl mx-auto space-y-6">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-card-foreground">
              Create Surveys. Get Insights. Act Confidently.
            </h2>
            <p className="text-muted-foreground">
              Marketmaker lets you generate AI-powered surveys, build anonymised Digital Twins, and understand your audience in minutes—not weeks.
            </p>
            <div className="flex justify-center gap-4">
              <Button size="lg" onClick={() => router.push("/register")}>Get started — it&apos;s free</Button>
              <Button variant="outline" size="lg" onClick={() => router.push("/login")}>Login</Button>
            </div>
          </section>
          ...
          <div className="max-w-2xl mx-auto">
            <Image
              src="/hero.jpg"
              alt="Illustration of Marketmaker survey and digital twin features"
          ...
          <section className="rounded-lg bg-primary/5 p-8 text-center space-y-4">
            ...
            <p className="text-muted-foreground">Join Marketmaker today and start understanding your audience.</p>
